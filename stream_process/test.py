...
# Hàm để kiểm tra tải mô hình
def load_model_from_path():
    model_path = '/home/nhtrung/CLV-Big-Data-Project/stream_process/model/CLV_V3.keras'  # Đường dẫn đến mô hình
