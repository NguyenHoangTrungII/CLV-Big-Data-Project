...
# # from batch_process.spark.spark_scripts.realtime_model_processing import consume_and_preprocess, preprocess_data
...
# # #    # Connect to HBase (Assuming a function to do so)
# # #    connection = connect_to_hbase()
...
# # #    # Consume data from Kafka and preprocess it
# # #    df_processed = consume_and_preprocess()  # This should be fetching and processing data
  
# # #    # Kiểm tra nếu DataFrame trống
# # # #    
# # #    # Predict CLV for the preprocessed data
# # #    df_with_predictions = predict_clv(df_processed)
# # #    print(df_with_predictions[['InvoiceNo', 'CLV_Prediction']])


# # #    # Insert the prediction data into HBase
# # #    insert_data_to_hbase(connection, df_with_predictions)
  
# # #    print("Prediction and data insertion completed.")
...
# try:
#     model = keras.models.load_model('/home/nhtrung/CLV-Big-Data-Project/stream_process/model/CLV_V3.keras', compile=False)
#     print("Model loaded successfully mimi.")
# except Exception as e:
#     print(f"Error loading model: {e}")
#     exit()
